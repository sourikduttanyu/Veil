    ...
    <div>
      <ResponsiveContainer width="100%" height={chartHeight}>
        <BarChart data={chartData} layout="vertical" margin={{ top: 0, right: 48, bottom: 4, left: 0 }}>
          ...
          <YAxis type="category" dataKey="name" tick={{ fill: "#c8c8d8", fontSize: 10 }} width={130} />
      ...
      <div className="flex justify-center gap-5 mt-2 text-[10px] text-[#9ca3af]">
...
function Empty() {
  return (
    <div className="flex flex-col items-center justify-center h-48 gap-2">
      <div className="text-[#6b7280] text-sm">No ad exposures yet</div>
